...
<script src="../Public/dwz/js/common.js" type="text/javascript"></script>
<style type="text/css">
...
.header h1{ background-image:url(../Public/Images/logo.gif);background-repeat:no-repeat;width:227px;height:78px;line-height:150px;overflow:hidden;font-size:0}
...
.qzone_cont .scroll_img li{ width:10px;height:10px;background-image:url(../Public/Images/qzone_login.png);background-position:-663px 0;background-repeat:no-repeat;display:inline-block;margin-right:15px;cursor:pointer;*display:inline;*zoom:1;overflow:hidden}
.qzone_cont .scroll_img .current_img{ background-image:url(../Public/Images/qzone_login.png);background-position:-663px -17px}
...
.login_main .login_list .txt_click{color:#ccc}
 #verifyImg{cursor:pointer;margin-left:10px;margin-bottom:10px;width:100px;height:50px;}
...
.login_main .login_btn{ width:148px;height:48px;line-height:150px;overflow:hidden;font-size:0;*background:none;background-image:url(../Public/Images/qzone_login.png);background-position:-514px 0;border:none;cursor:pointer}
...
.platform_box nav{ background-image:url(../Public/Images/qzone_login.png);background-position:0 0;background-repeat:no-repeat;width:370px;height:52px;margin:0 auto}
...
.footer{ background:#f0f0f0 url(../Public/Images/ft_bg.jpg) repeat-x;color:#999}
.footer .inner{width:1000px;margin:0 auto;text-align:center;padding:15px 0}
.footer .links{margin-bottom:15px}
.footer .links .sep{margin:0 12px;color:#d0d3d7}
.footer .copyright{width:580px;margin:0 auto}
.footer .copyright_en{float:left;margin-right:15px;font-size:16px;}
  ...
  <div class="inner">
    ...
    <div class="qzone_login clearfix">
      <div class="qzone_cont" id="_pt">
        <li><img src="../Public/Images/login_bg.jpg" alt="生活以快乐为基准，爱情以互惠为原则！"></li>
      </div>
      <!-- end qzone_cont -->
      <div class="login_main">
        <p class="wrong_notice" id="err_m" style="display:none;"></p>
        <form id="loginform" method="post" name="loginform" action="__URL__/checkLogin/"   >
          <ul class="login_list"  id="web_login">
            <li class="login_input">
              <input  value=""  id="u" name="name"  class="input_txt" tabindex="1"   type="text" value="" placeholder="帐号名" title="帐号名"  />
            </li>
            <li class="login_input">
            ...
            <li class="yanzhengma clearfix" id="verifytip"> <span id="verifyinput">
              ...
              <span><img id="verifyImg" SRC="__URL__/verify/" onClick="fleshVerify()" border="0" alt="点击刷新验证码"  align="absmiddle"></span>
            </li>
            <li>
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      <p class="copyright_en">Copyright &copy; 2014 - 2015 , 顶新软件 All Rights Reserved.</p>
      <p class="copyright_ch"></p>
    </div>
  </div>
</div>
</body>
